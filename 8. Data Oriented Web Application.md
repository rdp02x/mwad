...
> Develop a data oriented application for user data (**_user_id_**, **_name_**, **_address_**, **_contact_number_**) management. The application should provide interface to add, update, delete and list data of user(s).
